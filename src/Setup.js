 ...
 function setTogglCredentials() {
     ...
     console.log('Toggl credentials have been set. You can now delete the placeholder values from this function.');
 }
 ...
 function setGoogleFitCredentials() {
     ...
     console.log('Google Fit credentials have been set. You can now delete the placeholder values from this function.');
 }
 ...
 function authorizeGoogleFit() {
     ...
     if (!fitService) {
         console.error("Could not create Google Fit service. Have you run setGoogleFitCredentials()?");
         return;
     }
 ...
 function authCallback(request) {
     ...
     if (isAuthorized) {
         return HtmlService.createHtmlOutput('✅ Google Fit authorization successful! You may now close this tab.');
     } else {
